...
try {
	...
	for (const path of [
		...
		'Classes/BuildListControl.lua',
		'Classes/ButtonControl.lua',
		'Classes/CalcBreakdownControl.lua',
		'Classes/CalcSectionControl.lua',
		'Classes/CalcsTab.lua',
		'Classes/CheckBoxControl.lua',
		'Classes/ConfigTab.lua',
		'Classes/Control.lua',
		'Classes/ControlHost.lua',
		...
		'Classes/ItemListControl.lua',
		'Classes/ItemSetListControl.lua',
		'Classes/ItemSlotControl.lua',
		'Classes/ItemsTab.lua',
		'Classes/LabelControl.lua',
		'Classes/ListControl.lua',
		'Classes/MinionListControl.lua',
		'Classes/ModDB.lua',
		'Classes/ModList.lua',
		'Classes/ModStore.lua',
		'Classes/NotableDBControl.lua',
		'Classes/NotesTab.lua',
		'Classes/PartyTab.lua',
		'Classes/PassiveMasteryControl.lua',
		'Classes/PassiveSpec.lua',
		'Classes/PassiveSpecListControl.lua',
		'Classes/PassiveTree.lua',
		'Classes/PassiveTreeView.lua',
		'Classes/PathControl.lua',
		'Classes/PopupDialog.lua',
		'Classes/PowerReportListControl.lua',
		'Classes/RectangleOutlineControl.lua',
		'Classes/ScrollBarControl.lua',
		'Classes/SearchHost.lua',
		'Classes/SectionControl.lua',
		'Classes/SharedItemListControl.lua',
		'Classes/SharedItemSetListControl.lua',
		'Classes/SkillListControl.lua',
		'Classes/SkillSetListControl.lua',
		'Classes/SkillsTab.lua',
		'Classes/SliderControl.lua',
		'Classes/TextListControl.lua',
		'Classes/TimelessJewelListControl.lua',
		'Classes/TimelessJewelSocketControl.lua',
		'Classes/Tooltip.lua',
		'Classes/TooltipHost.lua',
		'Classes/TradeQuery.lua',
		'Classes/TradeQueryGenerator.lua',
		'Classes/TradeQueryRateLimiter.lua',
		'Classes/TradeQueryRequests.lua',
		'Classes/TradeStatWeightMultiplierListControl.lua',
		'Classes/TreeTab.lua',
